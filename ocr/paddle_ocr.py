...
def run_paddle_ocr(source, ocr_file_path, skip_frames=30):
    """
    ...
    try:
        ...
        while True:
            ...
            # For storing recognition results
...
if __name__ == "__main__":
    run_paddle_ocr(source="test_files/new.mp4", ocr_file_path="test_files/new_ocr.txt")
